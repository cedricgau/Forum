 ...
 */
public class NouvelleInterface extends RecyclerView.Adapter<NouvelleInterface.NouvelleTenue> {
    private int idNouvelles;
    String data1[],data2[],data3[];
    Context mContext;
    int images[];

    public NouvelleInterface(Context ct, String s1[], String s2[], String s3[], int img[]){
        mContext=ct;
        data1 = s1;
        data2 = s2;
        data3 = s3;
